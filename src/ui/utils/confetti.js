...
function ConfettiRibbon(_x, _y, _count, _dist, _thickness, _angle, _mass, _drag) {
  ...
  this.Draw = function(_g) {
    for (let i = 0; i < this.particleCount - 1; i++) {
      ...
      if (
        this.Side(this.particles[i].position.x, this.particles[i].position.y, this.particles[i + 1].position.x, this.particles[i + 1].position.y, p1.x, p1.y) <
        0
      ) {
        _g.fillStyle = this.frontColor;
...
const confetti = {};
confetti.Context = function(canvasEl) {
  let i = 0;
